...
class TestEmbeddingConfig:
    ...
    def test_embedding_config_custom_values(self):
        ...
        assert config.encode_kwargs == {'normalize_embeddings': False}
...
class TestSentenceTransformersProvider:
    ...
    def test_sentence_transformers_provider_not_implemented(self, provider):
...
class TestEmbeddingProviderFactory:
    ...
    def test_create_embedding_provider_sentence_transformers(self):
        ...
        # Should return PlaceholderEmbeddingProvider for now
...
class TestEmbeddingManager:
    ...
    def test_embedding_manager_init_default_config(self):
        ...
        assert isinstance(manager.provider, PlaceholderEmbeddingProvider)
